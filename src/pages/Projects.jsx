        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 lg:mb-12">
            ...
            <p className="text-lg text-gray-600 mb-3">
              Explore the mini projects, major projects, and internship projects
            </p>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8">
            {tabs.map((tab) => (
              <button
                ...
                className={`px-4 py-2 rounded-md border text-sm font-medium transition-colors ${activeTab === tab
            ...
            {projects.length > 0 ? (
              projects.map((project, index) => (
                <article key={index} className="border border-gray-200 rounded-md p-5">
                  ...
                  {project.mentor && (
                    <p className="text-gray-700 mb-2">Mentor : {project.mentor}</p>
                  )}
                  {project.duration && (
